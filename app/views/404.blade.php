...
<head>
	...
	<style type="text/css">
		...
		*/
		...
		#fof{display:block; position:relative; width:100%; height:450px; background:url("{{asset('public/backend')}}/assets/img/404.png") top center no-repeat; line-height:1.6em; text-align:center;}
